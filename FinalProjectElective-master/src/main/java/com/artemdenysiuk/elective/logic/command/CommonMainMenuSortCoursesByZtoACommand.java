...
public class CommonMainMenuSortCoursesByZtoACommand implements Command {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) throws DBException {
        ...
        List<Course> sortedZAList = CourseManager.findAllCoursesForMainMenuSortByZToA(pageSize*(page-1), pageSize);
        ...
        req.setAttribute("sortedZAList", sortedZAList);
