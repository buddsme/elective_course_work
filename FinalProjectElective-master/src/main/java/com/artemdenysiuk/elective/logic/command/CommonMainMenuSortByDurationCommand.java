...
public class CommonMainMenuSortByDurationCommand implements Command {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) throws DBException {
        ...
        List<Course> sortedDurationList = CourseManager.findAllCoursesForMainMenuSortByDuration(pageSize*(page-1), pageSize);
        ...
        req.setAttribute("sortedDurationList", sortedDurationList);
